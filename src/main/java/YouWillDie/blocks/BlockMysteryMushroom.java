...
public class BlockMysteryMushroom extends BlockFlower {
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		icon = par1IconRegister.registerIcon("YouWillDie:mushroomBlock");
		overlay = par1IconRegister.registerIcon("YouWillDie:mushroomBlock_overlay");
		blockIcon = icon;
	}
	...
	public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random) {
	 ...
	 public ItemStack getPickBlock(MovingObjectPosition object, World par1World, int par2, int par3, int par4) {
		 return new ItemStack(ModRegistry.mysteryMushroom);
	 }

	 @Override
	 public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_)
	 {
		 return ModRegistry.mysteryMushroom;
	 }
