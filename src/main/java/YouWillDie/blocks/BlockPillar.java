...
public class BlockPillar extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		blockIcon = par1IconRegister.registerIcon("YouWillDie:pillar");
	}
	...
	public ItemStack getPickBlock(MovingObjectPosition object, World par1World, int par2, int par3, int par4) {
		return new ItemStack(ModRegistry.itemPillar);
	}
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)  {
		...
		if(par5EntityPlayer.getHeldItem() == null || par5EntityPlayer.getHeldItem().getItem() == null || par5EntityPlayer.getHeldItem().getItemDamage() != 1 || par5EntityPlayer.getHeldItem().getItem() != ModRegistry.sceptre) {
	...
	public int getLightValue(IBlockAccess world, int x, int y, int z) {
		...
		if(Config.pillarGlow && net.minecraft.client.Minecraft.getMinecraft().theWorld != null && net.minecraft.client.Minecraft.getMinecraft().theWorld.isRemote) {
